...
TableTools.prototype = {
	  ...
	  var nButton = this._fnButtonBase( oConfig, bCollectionButton );
		...
		if ( this.s.dt.iTabIndex !== -1 ) {
			$(nButton)
				...
				.on( 'http://megadin.lab.themebucket.net/bower_components/datatables-tabletools/js/keyup.DTTT', function (e) {
				...
				.on( 'http://megadin.lab.themebucket.net/bower_components/datatables-tabletools/js/mousedown.DTTT', function (e) {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		 ...
		 */
		$(document).bind( "http://megadin.lab.themebucket.net/bower_components/datatables-tabletools/js/keydown.DTTT", function(e) {
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "http://megadin.lab.themebucket.net/bower_components/datatables-tabletools/js/keydown.DTTT" );
	},
...
TableTools.BUTTONS = {
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		"sAjaxUrl": "http://megadin.lab.themebucket.net/xhr.php",
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":        "copy_csv_xls_pdf-1.swf"/*tpa=http://megadin.lab.themebucket.net/bower_components/datatables-tabletools/swf/copy_csv_xls_pdf.swf*/,
	"sRowSelect":      "none",
	"sRowSelector":    "tr",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
