...
ColVis.prototype = {
	...
	"_fnConstruct": function ( init )
	{
		 ...
		 */
		$(this.s.dt.oInstance).bind( 'http://megadin.lab.themebucket.net/bower_components/datatables-colvis/js/column-reorder.dt', function ( e, oSettings, oReorder ) {
		...
		$(this.s.dt.oInstance).bind( 'http://megadin.lab.themebucket.net/bower_components/datatables-colvis/js/destroy.dt', function () {
